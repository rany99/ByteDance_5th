...
type FeedListResponse struct {
	List     []*models2.Video `json:"video_list,omitempty"`
...
type QueryFeedListFlow struct {
	...
	videos     []*models2.Video //返回视频列表，长度最长为Limit = 30
...
func (q *QueryFeedListFlow) GetData() error {
	if err := models2.NewVideoDao().QueryVideoListByLastTimeAndLimit(q.latestTime, Limit, &q.videos); err != nil {
		return err
	}
...
// FillVideos 更新视频作者信息
func FillVideos(userid int64, videos *[]*models2.Video) (*time.Time, error) {
