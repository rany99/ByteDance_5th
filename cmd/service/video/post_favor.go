...
func (p *PostFavorFlow) AddOne() error {
	if err := models2.NewVideoDao().FavoriteCountAddOneByVideoId(p.uid, p.vid); err != nil {
...
func (p *PostFavorFlow) SubOne() error {
	if err := models2.NewVideoDao().FavoriteCountSubOneByVideoId(p.uid, p.vid); err != nil {
		if err != nil {
