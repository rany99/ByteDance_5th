...
import (
	user2 "ByteDance_5th/cmd/service/user"
...
func RegisterController(ctx *gin.Context) {
	...
	// 调用Service层
	registerResponse, err := user2.PostUserLogin(username, password)
	if err != nil {
...
func RegisterSucceed(ctx *gin.Context, registerResponse *user2.LoginResponse) {
	ctx.JSON(http.StatusOK, LoginResponse{
		CommonResponse: common.CommonResponse{
			StatusCode: 0,
		},
